...
export async function createHypertable(
    ...
    try {
        ...
        console.log(
            `✓ Hypertable created: ${tableName} (chunked by ${chunkTimeInterval})`
        );
        return result;
    } catch (error) {
...
export async function addRetentionPolicy(
    ...
    try {
        ...
        console.log(
            `✓ Retention policy added: ${tableName} (keep ${retentionPeriod})`
        );
        return result;
    } catch (error) {
...
export async function removeRetentionPolicy(
    ...
    try {
        ...
        console.error(
            `Failed to remove retention policy from ${tableName}:`,
            error
        );
        throw error;
    }
...
export async function enableCompression(
    ...
    try {
        ...
        console.log(
            `✓ Compression enabled: ${tableName} (compress after ${compressAfter})`
        );
        return result;
    } catch (error) {
...
export async function createContinuousAggregate(
    ...
    try {
        ...
        console.error(
            `Failed to create continuous aggregate ${viewName}:`,
            error
        );
        throw error;
    }
...
export async function compressChunks(
    ...
    try {
        ...
        console.log(
            `✓ Compressed chunks for ${tableName} older than ${olderThan}`
        );
        return result;
    } catch (error) {
